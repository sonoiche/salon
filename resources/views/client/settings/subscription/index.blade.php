        ...
        <div class="card custom-card">
            <div class="card-header d-sm-flex d-block">
                <ul class="nav nav-tabs nav-tabs-header mb-0 d-sm-flex d-block" role="tablist">
                    ...
                    <li class="nav-item m-1">
                        <a class="nav-link active" href="{{ url('client/settings/subscription') }}" aria-selected="true">Subscriptions</a>
                    </li>
                    <li class="nav-item m-1">
            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    @include('client.settings.tabs.subscription', ['active' => true])
...
@push('scripts')
{!! JsValidator::formRequest('App\Http\Requests\Client\SubscriptionRequest') !!}
